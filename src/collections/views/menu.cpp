...
v_Menu::v_Menu(const std::vector<const char*> &button_lables, SmartColor *button_color, SmartColor *text_color, SmartColor *back_color, int char_size, Vec2d button_scale):
