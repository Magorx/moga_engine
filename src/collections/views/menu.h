...
public:
    v_Menu(const std::vector<const char*> &button_labels, SmartColor *button_color, SmartColor *text_color, SmartColor *back_color = nullptr, int char_size = 15, Vec2d button_scale = {1.3, 1.3});
    virtual ~v_Menu();
